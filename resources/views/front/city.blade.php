...
<section id="latest" class="flex flex-col w-full max-w-[1280px] gap-8 mx-auto px-10 mb-10 ">
    <div class="flex items-center justify-between">
        <div class="flex flex-col gap-4">
            <h2 class="font-['ClashDisplay-SemiBold'] text-5xl leading-[59px] tracking-05">{{$city->name}}</h2>
            <p class="leading-19 tracking-03 opacity-60">Pilihan gym di kota “{{$city->name}}”</p>
        </div>
    </div>
                        ...
                        <div class="flex flex-col rounded-3xl p-8 gap-6 bg-white">
                            <div class="title flex flex-col gap-2">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <p class="text-sm leading-19 tracking-03 opacity-50">{{$itemNewGym->cities->name}}</p>
                                </div>
                            </div>
                                ...
                                <div class="flex flex-col gap-3 items-center text-center">
                                    ...
                                    <div class="flex flex-col gap-1">
                                        <p class="font-semibold text-sm leading-16 tracking-05">
                                            {{ optional($itemFacility->facility)->name ?? 'Fasilitas tidak tersedia' }}
                                        </p>
                                        <p class="opacity-50 text-sm leading-16 tracking-05">
                                            {{ optional($itemFacility->facility)->about ?? 'Fasilitas tidak tersedia' }}
                                        </p>
                                    </div>
                                </div>
                                @empty
