@extends('layouts.app')
@section('title')
Gym di {{$gym->name}} Detail
@endsection

@section('content')

<div id="background" class="absolute w-full h-[355px] top-0 z-0 bg-sky-500"></div>
...
<main id="content" class="relative flex w-full max-w-[1280px] gap-6 mx-auto px-10 mt-[96px]">
    <section id="details" class="flex flex-col gap-6 w-full max-w-[820px] flex-1">
        ...
        <div id="gallery" class="grid grid-cols-4 gap-4">
            <button class="w-full rounded-2xl bg-[#D9D9D9] overflow-hidden transition-all duration-300 ring-[3px] ring-[#835DFE]">
        ...
        <div id="place-info" class="flex flex-col w-full rounded-3xl p-8 gap-12 bg-white">
            <div class="flex items-center justify-between gap-4">
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <p class="text-xl leading-6 tracking-05 opacity-50">{{$gym->cities->name}}</p>
                    </div>
                </div>

                @if ($gym->is_popular)
                <p class="rounded-full py-3 px-6 bg-[#E56062] w-fit font-semibold leading-19 tracking-05 text-white">Populer</p>
                @endif
               
            </div>
            <div class="flex flex-col gap-6">
                <h2 class="font-['ClashDisplay-SemiBold'] text-xl leading-6 tracking-05">Daftar fasilitas</h2>
            ...
            <div class="flex items-center gap-8">
                <div class="flex items-center gap-3 shrink-0">
                    <img src="{{asset('assets/images/icons/clock.png')}}" class="w-20 h-20 flex shrink-0" alt="icon">
                    <div class="flex flex-col gap-2">
                        <p class="font-['ClashDisplay-SemiBold'] text-xl leading-6 tracking-05">Opening Work</p>
                        <p class="text-xs leading-14 tracking-05 opacity-50">{{$gym->open_time_at->format('h:i A')}} - {{$gym->closed_time_at->format('h:i A')}}</p>
                    </div>
                </div>
                <div class="flex items-center gap-8">
                    <img src="{{asset('assets/images/icons/Adress.png')}}" class="w-20 h-20 flex shrink-0" alt="icon">
        ...
        <div id="reviews" class="flex flex-col w-full rounded-3xl p-8 gap-8 bg-white mb-10">
            <div class="flex flex-col gap-4">
                <h2 class="font-['ClashDisplay-SemiBold'] text-[48px] leading-[59px] tracking-05">Testimonial </h2>
            </div>
    ...
    <aside class="flex flex-col gap-6">
        <div class="flex flex-col w-full rounded-3xl p-8 gap-6 bg-white">
            <p class="font-['ClashDisplay-SemiBold'] leading-19 tracking-05">Benefit member</p>
