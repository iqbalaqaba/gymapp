...
<main id="content" class="relative flex w-full  h-fit mx-auto  bg-grey overflow-hidden">

    <div class="relative flex flex-col w-full items-center">
        <div class="flex flex-col gap-4 text-center mx-auto mt-12">
            <h2 class="font-['ClashDisplay-SemiBold'] text-5xl leading-[59px] tracking-05">Pilihan paket gym</h2>
            <p class="leading-19 tracking-03 opacity-60">pilih paket terbaikmu</p>
        </div>
        <div class="flex gap-8 max-w-[1132px] mx-auto mt-20 mb-[124px]">
            ...
            <div class="card flex flex-col w-[356px] rounded-3xl p-8 gap-6 bg-white">
                <div class="flex items-center justify-center">
                    <img src="{{Storage::url($itemSubscribe->icon)}}" class="w-32 h-32">
                </div>
            ...
            @endforeach
                ...
                <div class="flex items-center justify-between mt-auto">
                    <a href="{{route('front.booking', $itemSubscribe->id)}}" class="w-fit rounded-full py-3 px-6 bg-[#606DE5] font-semibold leading-19 tracking-05 text-white text-center">Pilih paket ini</a>
                    <p class="text-right font-semibold leading-19 tracking-05">
                        Rp {{number_format($itemSubscribe->price, 0, ',', '.')}}<span class="font-normal opacity-50">/<br>
                        {{$itemSubscribe->duration}} hari
                        </span>
                    </p>
                </div>
            </div>
