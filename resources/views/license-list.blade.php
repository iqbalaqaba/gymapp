    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            ...
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                Beli lisensi penggunaan aplikasi gymapp anda disini
            </h1>
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
                Pantau, perbarui, dan kelola semua lisensi aplikasi GymApp Anda dalam satu tempat yang praktis. Nikmati kemudahan administrasi tanpa repot!
            </p>
        </div>
    </section>
            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                        Lisensi Tersedia untuk GymApp Anda
                    </h2>
                    <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
                        Pilih dan aktifkan lisensi yang sesuai dengan kebutuhan gym Anda untuk pengalaman terbaik dalam manajemen fitness.
                    </p>
                </div>
                <div class="flex justify-center items-center py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div class="grid gap-6 lg:grid-cols-2 xl:gap-10">
                    <!-- Pricing Card -->
                    <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                        <h3 class="mb-4 text-2xl font-semibold">Bulanan</h3>
                        <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                        Lisensi bulanan
                        </p>
                        <div class="flex justify-center items-baseline my-8">
                            <span class="mr-2 text-2xl font-extrabold">Rp. 400.000</span>
                        ...
                        <ul role="list" class="mb-8 space-y-4 text-left">
                            <li class="flex items-center space-x-3">
                                ...
                                <span>
                                    Akses Premium Fitur GymApp
                                </span>
                            </li>
                            <li class="flex items-center space-x-3">
                                <!-- Icon -->
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                                <span>Pembaharuan Otomatis</span>
                            </li>
                            <li class="flex items-center space-x-3">
                                <!-- Icon -->
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                    ...
                    <!-- Pricing Card -->
                    <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                        <h3 class="mb-4 text-2xl font-semibold">Tahunan</h3>
                        <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Lisensi tahunan</p>
                        <div class="flex justify-center items-baseline my-8">
                            <span class="mr-2 text-2xl font-extrabold">Rp. 600.000</span>
