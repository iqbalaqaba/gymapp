...
<form action="{{route('front.check_booking_details')}}" method="POST" class="relative flex flex-col items-center w-full max-w-[642px] text-center rounded-3xl p-8 py-[70px] gap-8 bg-white mx-auto mt-10 mb-10">

    @csrf
    <div class="flex flex-col items-center gap-4">
        <h1 class="font-['ClashDisplay-SemiBold'] text-[32px] leading-10 tracking-05">Check subscription saya</h1>
    </div>
