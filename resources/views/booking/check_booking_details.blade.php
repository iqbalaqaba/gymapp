...
<div class="relative flex justify-center w-full max-w-[1280px] gap-6 mx-auto px-10 mt-10 mb-10">
    <div class="flex flex-col w-full max-w-[665px] shrink-0 rounded-3xl px-[57.5px] py-[46px] gap-6 bg-white">
        <h1 class="font-['ClashDisplay-SemiBold'] text-[32px] leading-10 tracking-05 text-center">Detail membership</h1>
        ...
        <div class="flex items-center justify-between">
            ...
            <p class="leading-19 tracking-05">
                {{$bookingDetails->ended_at->format('M, d, Y')}}
            </p>
        </div>
        <div class="flex items-center justify-between">
            <p class="font-['ClashDisplay-SemiBold'] leading-19 tracking-05">Total Payment</p>
            <p class="leading-19 tracking-05 font-bold">
                Rp {{number_format($bookingDetails->total_ammount, 0, ',', '.')}}
            </p>
        </div>
        <div class="flex items-center justify-between">
    ...
    <div class="flex flex-col w-full max-w-[356px] h-fit rounded-3xl p-8 gap-6 bg-white">
        <h1 class="font-['ClashDisplay-SemiBold'] text-[32px] leading-10 tracking-05 text-left">Paket anda</h1>
        <div class="flex flex-col gap-2">
            <p class="font-['ClashDisplay-SemiBold'] leading-19 tracking-05">
                {{$bookingDetails->subscribePackage->name}}
            </p>
        </div>
        <p class="font-semibold leading-19 tracking-05">
            Rp {{number_format($bookingDetails->subscribePackage->price, 0, ',', '.')}}
            <span class="font-normal opacity-50">/
                {{$bookingDetails->subscribePackage->duration}} days
            </span>
        </p>
    </div>
</div>
